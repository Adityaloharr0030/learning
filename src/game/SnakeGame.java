...
public class SnakeGame extends JPanel implements ActionListener {
    ...
    static final int DELAY = 100; // Game speed (lower is faster)
        ...
        if (running) {
            ...
            for (int i = 0; i < bodyParts; i++) {
                if (i == 0) {
                    ...
                    g.setColor(new Color(255, 0, 80, 213)); // Body
                }
    ...
    public void gameOver(Graphics g) {
        ...
        g.drawString("Score: " + applesEaten, (SCREEN_WIDTH - metrics2.stringWidth("Score: " + applesEaten)) / 2, g.getFont().getSize() + 300);
    }
    ...
    // Main method to create the window and start the game
